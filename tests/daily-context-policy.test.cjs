...
test('worker and Today page preserve the daily lifecycle boundary behind consumer UX', () => {
  ...
  assert.match(checkin, /Ada yang beda hari ini\?/)
  assert.match(checkin, /NGGAK ADA/)
