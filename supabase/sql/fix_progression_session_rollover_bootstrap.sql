...
begin
  ...
  v_created := v_previous_session_id is null or v_session.id <> v_previous_session_id;
...
revoke execute on function public.ensure_player_progression_session(date) from public, anon;
